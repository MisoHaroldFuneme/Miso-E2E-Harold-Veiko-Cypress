...
context(`Testing create Post (Draft) - Escenario Random ${i}: Login OK e ingreso de Título y descripción - Faker`, () => { 
    ...
    it('Enter Title', () => {
        cy.get('textarea').first().type(faker.image.avatar());
        cy.get('.koenig-editor__editor').type(aker.lorem.paragraph());
        cy.wait(2000)
